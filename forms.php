...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="validateForms.php" method="post" role="form"
                  class="form-horizontal col-xs-10 col-xs-offset-1">
                <div class="form-group">
                    <label for="firstName">Prénom : </label>
                    <input type="text" class="form-control" name="firstName" id="firstName" placeholder="ex: Michel"
                           required
                           value="<?php echo isset($_SESSION['errors']['firstName']) ? "" : $_SESSION['inputs']['firstName']; ?>">
                </div>
                <div class="form-group">
                    <label for="lastName">Nom : </label>
                    <input type="text" class="form-control" name="lastName" id="lastName" placeholder="ex: Dupont"
                           required

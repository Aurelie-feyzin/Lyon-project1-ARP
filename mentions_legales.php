...
<div class="container">
    ...
    <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
        précisé aux utilisateurs du site <a href="http://www.bugburger.com/">www.bugburger.com</a> l'identité des
    ...
    <div class="encadre">
        ...
        <strong>Responsable publication</strong> : Mister Bug's – bug@bugburger.com<br/>
        <strong>Webmaster</strong> : Web Bug – webbug@bugburger.com<br/>
        <strong>Hébergeur</strong> : 127.0.0.1:8000 7, Rue des insectes, 28240 La Loupe<br/>
    </div>
    ...
    <div>
        ...
        <p>L’utilisation du site <a href="http://www.bugburger.com/">www.bugburger.com</a> implique l’acceptation pleine
            ...
            susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
                    href="http://www.bugburger.com/">www.bugburger.com</a> sont donc invités à les consulter de manière
            régulière.</p>
        <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par Bug Burger, qui s’efforcera alors de communiquer
            préalablement aux utilisateurs les dates et heures de l’intervention.</p>
        <p>Le site <a href="http://www.bugburger.com/">www.bugburger.com</a> est mis à jour régulièrement par Bug'Papa.
        ...
        <p>Le site <a href="http://www.bugburger.com/">www.bugburger.com</a> a pour objet de fournir une information
        ...
        <p>Tous les informations indiquées sur le site <a href="http://www.bugburger.com/">www.bugburger.com</a> sont
            données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le
            site <a href="http://www.bugburger.com/">www.bugburger.com</a> ne sont pas exhaustifs. Ils sont donnés sous
        ...
        <p>Bug Burger ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
            l’utilisateur, lors de l’accès au site www.bugburger.com, et résultant soit de l’utilisation d’un matériel
            ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
            incompatibilité.</p>
        <p>Bug Burger ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte
            de marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://www.bugburger.com/">www.bugburger.com</a>.
        </p>
        <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
            utilisateurs. Bug Burger se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu
            déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux
            dispositions relatives à la protection des données. Le cas échéant, Bug Burger se réserve également la
        ...
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a href="http://www.bugburger.com/">www.bugburger.com</a>, peuvent
            êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                    href="http://www.bugburger.com/">www.bugburger.com</a>, le fournisseur d'accès de l'utilisateur,
            l'adresse de protocole Internet (IP) de l'utilisateur.</p>
        <p> En tout état de cause Bug Burger ne collecte des informations personnelles relatives à l'utilisateur que
            pour le besoin de certains services proposés par le site <a href="http://www.bugburger.com/">www.bugburger.com</a>.
            L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par
            lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://www.bugburger.com/">www.bugburger.com</a>
        ...
        <p>Aucune information personnelle de l'utilisateur du site <a
                    href="http://www.bugburger.com/">www.bugburger.com</a> n'est publiée à l'insu de l'utilisateur,
            échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de
            Bug Burger et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui
            serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de
            l'utilisateur du site <a href="http://www.bugburger.com/">www.bugburger.com</a>.</p>
        ...
        <p>Le site <a href="http://www.bugburger.com/">www.bugburger.com</a> contient un certain nombre de liens
            hypertextes vers d’autres sites, mis en place avec l’autorisation de Bug Burger. Cependant, Bug Burger n’a
        ...
        <p>La navigation sur le site <a href="http://www.bugburger.com/">www.bugburger.com</a> est susceptible de
        ...
        <p>Tout litige en relation avec l’utilisation du site <a href="http://www.bugburger.com/">www.bugburger.com</a>

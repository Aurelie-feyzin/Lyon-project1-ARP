...
return
    [
        [
            'nom' => 'Damien Armenté',
            'image' =>  'Images/damien250x250.jpg',
            'bio' => 'Chercheur au CNRS, spécialisé en bioproduction d’insectes depuis 12 ans. Il
        ...
        [
            'nom' => 'Laurent Aubertin',
            'image' => 'Images/laurent250x250.jpg',
            'bio' => 'Chef doublement étoilé. Précédemment chef dans le prestigieux Restaurant “Au bon
                ...
                dans chacuns de nos restaurants'
        ],
        [
            'nom' => 'Julien Boyer',
            'image' =>  'Images/Julien-Boyer-250x250.jpg',
            'bio' => 'Serial Entrepreneur, après un séjour de 4 ans en Asie du sud-est, il décide de
                ...
                Restaurant Bug burger 6 mois plus tard.'
        ],
    ];
